...
ActiveRecord::Schema[7.1].define(version: 2024_04_08_164018) do
  ...
  create_table "transaction_value_extractors", force: :cascade do |t|
    t.integer "message_dispatcher_id", null: false
    t.integer "field"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["message_dispatcher_id"], name: "index_transaction_value_extractors_on_message_dispatcher_id"
  end
